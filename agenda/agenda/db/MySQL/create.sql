...
create table Medico(id bigint not null auto_increment, crm bigint not null unique, nome varchar(256) not null,  senha varchar(64) not null, email varchar(128) not null, especialidade varchar(256) not null);
